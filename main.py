...
cifar10_train = CIFAR10('../ntk-al/data/cifar10', train=True, download=True, transform=train_transform)
cifar10_unlabeled = CIFAR10('../ntk-al/data/cifar10', train=True, download=True, transform=test_transform)
cifar10_test = CIFAR10('../ntk-al/data/cifar10', train=False, download=True, transform=test_transform)
